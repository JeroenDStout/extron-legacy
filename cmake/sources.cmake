...
macro(internal_recursive_setup_project_source mode arg1 arg2)
  ...
  if (${arg1} STREQUAL "src:")
    internal_recursive_setup_project_source("src" ${arg2} ${ARGN})
  elseif (${arg1} STREQUAL "include:")
    internal_recursive_setup_project_source("include" ${arg2} ${ARGN})
  elseif (${arg1} STREQUAL "script:")
    internal_recursive_setup_project_source("script" ${arg2} ${ARGN})
  elseif (NOT ${arg2} STREQUAL "GENERATED")
    internal_add_project_source(${mode} ${arg1})
	if (${ARGC} GREATER 3)
	  internal_recursive_setup_project_source(${project_source_group} ${mode} ${arg2} ${ARGN})
	else()
	  internal_add_project_source(${mode} ${arg2})
	endif()
  else()
    internal_add_project_source("${mode};generated" ${arg1})
	if (${ARGC} GREATER 4)
	  internal_recursive_setup_project_source(${project_source_group} ${mode} ${ARGN})
	elseif (${ARGC} GREATER 3)
	  internal_add_project_source(${mode} ${ARGV2})
	endif()
  endif()
endmacro()
